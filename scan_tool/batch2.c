...
inline void traverse(unsigned long dst, unsigned long start, unsigned long next_offset,
												...
												unsigned long offset2, unsigned long size2) {
	...
	do
	{
		...
		pos += size1;
		memcpy_v((unsigned long *)(dst + pos), (unsigned long *)(cur + offset2), size2);
		pos += size2;
...
//			goto fail;
		...
		traverse((unsigned long)(&buffer[7]), buffer[1], buffer[2],
